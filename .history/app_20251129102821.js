    ...
    const seed = {
      ...
      cars: [
        ...
        { id: 'c2', plate:'DDL 320', title:'BMW 3 Touring', image:'images/bmw.png' },
        { id: 'c3', plate:'SSS 777', title:'Ford Focus', image:'images/focus.png' },
      ],
      reservations: [],
      defects: [],
      docs: [
    ...
    function taStatus(iso){
      ...
      if (diffDays < 0) return { label:'PASIBAIGĘ', class:'bad' };
    ...
    function createManualBlock(){
      ...
      db.blocks.push({ carId, reason, from, to });
      saveDB(db);
      render();
    }
